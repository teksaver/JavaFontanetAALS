...
- Méthodes spéciales : Constructeurs, accesseurs, mutateurs
- Variables d'instances, de classe, locales
- static ou non
- Le mot clé this
- visibilité
- terminologie
- debugger
- boucle alternative (page  68)
- vérifier que 2 rois ne se touchent pas
